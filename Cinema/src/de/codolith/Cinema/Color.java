...
public class Color {
	...
	public static final Color[] colors = new Color[]{
		...
		new Color(122,122,122,Material.COBBLESTONE,(byte)0),//cobblestone
		new Color(143,139,124,Material.GOLD_ORE,(byte)0),//goldore
		new Color(182,182,57,Material.SPONGE,(byte)0),//sponge
		...
		new Color(29,71,165,Material.LAPIS_BLOCK,(byte)0),//lapis block
		new Color(102,112,134,Material.LAPIS_ORE,(byte)0),//lapis ore
		//new Color(218,210,158,,0),//sandstonetop
		new Color(216,209,157,Material.SANDSTONE,SandstoneType.CRACKED.getData()),//sandstone
		//new Color(212,205,148,,0),//ssandcracks???
		new Color(44,22,26,Material.NETHER_BRICK,(byte)0),//netherbrick
		//new Color(137,137,137,,0),//crack 1
		//0
		new Color(125,125,125,Material.STONE,(byte)0),//cleanstone
		//new Color(83,83,83,,0),//bedrock. better dont use
		new Color(135,130,126,Material.IRON_ORE,(byte)0),//iron ore
		...
		//1
		new Color(134,96,67,Material.DIRT,(byte)0),//dirt
		new Color(219,211,160,Material.SAND,(byte)0),//sand
		new Color(115,115,115,Material.COAL_ORE,(byte)0),//coal ore
		new Color(129,140,143,Material.DIAMOND_ORE,(byte)0),//diamond ore
		new Color(239,251,251,Material.SNOW_BLOCK,(byte)0),//snow
		...
		new Color(131,123,123,Material.GRAVEL,(byte)0),//gravel
		//new Color(107,88,57,,0),//bookshelf
		new Color(132,107,107,Material.REDSTONE_ORE,(byte)0),//redstone ore
		new Color(125,172,254,Material.ICE,(byte)0),//ice
		...
		new Color(70,43,26,Material.REDSTONE_LAMP_OFF,(byte)0),//redstone lamp off
		//new Color(108,15,22,,0),//nether shroom 2
		//new Color(106,106,106,,0),//crack 4
		//3
		new Color(156,127,78,Material.WOOD,(byte)0),//wood planks
		//new Color(102,81,49,,0),//wood sides
		new Color(103,121,103,Material.MOSSY_COBBLESTONE,(byte)0),//mossy cobble
		...
		new Color(119,89,55,Material.REDSTONE_LAMP_ON,(byte)0),//redstone lamp on
		//new Color(111,18,17,,0),//nether shroom 3
		//new Color(105,105,105,,0),// crack 5
		//4
		new Color(166,166,166,Material.DOUBLE_STEP,(byte)0),//double slap
		//new Color(154,125,77,,0),//log top
		new Color(20,18,29,Material.OBSIDIAN,(byte)0),//obsidian
		...
		new Color(215,208,154,Material.SANDSTONE,SandstoneType.GLYPHED.getData()),//glyphed sandstone
		//new Color(104,104,104,,0),//crack 6
		//5
		//new Color(159,159,159,,0),//slap top
		new Color(219,219,219,Material.IRON_BLOCK,(byte)0),//iron block
		//new Color(143,143,143,,0),//??
		new Color(122,122,122,Material.BRICK,(byte)0),//stone brick
		//new Color(13,102,24,,0),//cactus side
		//new Color(75,40,13,,0),//field wet
		//new Color(192,118,21,,0),//pumpkin up
		new Color(197,120,23,Material.PUMPKIN,(byte)0),//pumpkin side
		...
		new Color(219,211,161,Material.SANDSTONE,SandstoneType.SMOOTH.getData()),//sandstone smooth
		//new Color(102,102,102,,0),//crack 7
		//6
		new Color(146,99,86,Material.CLAY_BRICK,(byte)0),//brick
		new Color(249,236,78,Material.GOLD_BLOCK,(byte)0),//gold block
		//new Color(116,116,116,,0),//??
		//new Color(123,79,25,,0),//??
		//new Color(162,186,122,,0),//cactus cut
		//new Color(115,75,45,,0),//field not wet
		new Color(111,54,52,Material.NETHERRACK,(byte)0),//nether rack
		...
		//7
		new Color(169,92,71,Material.TNT,(byte)0),//tnt side
		new Color(97,219,213,Material.DIAMOND_BLOCK,(byte)0),//diamond block
		//new Color(145,145,145,,0),//??
		//new Color(120,120,120,,0),//??
		new Color(158,164,176,Material.CLAY,(byte)0),//clay
		//new Color(0,179,18,,0),//wheat 1
		new Color(84,64,51,Material.SOUL_SAND,(byte)0),//soulsand
		//new Color(185,133,28,,0),//pumpkin light front
		new Color(141,145,36,Material.MELON_BLOCK,(byte)0),//melon side
		...
		new Color(143,118,69,Material.GLOWSTONE,(byte)0),//glowstone 
		...
		new Color(100,67,50,Material.JUKEBOX,(byte)0),//jukebox
		...
		new Color(118,95,60,Material.WORKBENCH,(byte)0),//workbench side 1
		...
		new Color(113,113,113,Material.DISPENSER,(byte)0),//stove side//dispenser
		//new Color(125,102,85,,0),//stove on 
		new Color(113,88,73,Material.MYCEL,(byte)0),//mycelium side
		...
		new Color(221,223,165,Material.ENDER_STONE,(byte)0),//ender stone
		/*new Color(201,119,239,,0),
		...
		//wools
		new Color(23,23,23,Material.WOOL, DyeColor.BLACK.getData()),
		new Color(220,220,220,Material.WOOL,DyeColor.WHITE.getData()),
		new Color(150,50,50,Material.WOOL,DyeColor.RED.getData()),
		new Color(78,50,31,Material.WOOL,DyeColor.BROWN.getData()),
		new Color(175,165,40,Material.WOOL,DyeColor.YELLOW.getData()),
		new Color(125,60,180,Material.WOOL,DyeColor.PURPLE.getData()),
		new Color(45,110,135,Material.WOOL,DyeColor.CYAN.getData()),
		new Color(220,125,60,Material.WOOL,DyeColor.ORANGE.getData()),
		
		new Color(63,63,63,Material.WOOL,DyeColor.GRAY.getData()),//dark gray
		new Color(156,156,156,Material.WOOL,DyeColor.SILVER.getData()),//light gray
		
		new Color(180,80,190,Material.WOOL,DyeColor.MAGENTA.getData()),//dark pink
		new Color(200,125,150,Material.WOOL,DyeColor.PINK.getData()),//light pink
		
		new Color(50,70,25,Material.WOOL,DyeColor.GREEN.getData()),//dark green
		new Color(65,175,55,Material.WOOL,DyeColor.LIME.getData()),//light green
		
		new Color(45,55,140,Material.WOOL,DyeColor.BLUE.getData()),//dark blue
		new Color(100,135,200,Material.WOOL,DyeColor.LIGHT_BLUE.getData())
	};
	
	private int r,g,b;
	private Material material;
	private  byte data;
	public Color(int r,int g,int b,Material material,byte data){
		this.r=r;
		this.g=g;
		this.b=b;
	...
	public Color(int r,int g,int b){
		this(r,g,b,null,(byte)0);
	}
	
	public static CBlock fromColor(Vector3Int position, int rgba){
		...
		return new CBlock(position, nearest.material, nearest.data);
	}
